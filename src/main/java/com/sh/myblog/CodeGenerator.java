...
//        gc.setOutputDir("D:\\test");
        ...
        strategy.setSuperEntityClass("com.sh.myblog.entity.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        strategy.setSuperControllerClass("com.sh.myblog.controller.BaseController");
